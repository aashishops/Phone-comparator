...
st.title("Phone Comparator")


#creating a dataframe from the csv file
soft_df = pd.read_csv("https://raw.githubusercontent.com/aashishops/phone_data/main/phone_data")
st.write(soft_df)
...
def comparephones():
    ...
    if (ask=="one"):
        print("The User Wants to Compare one Phone")
    else :
        print("The User Wants to Compare ",ask, " Phones")
    if(ask=="one"):
...
#Fill in the area plotted in the last line
        ...
        dispdata = tocomparetwo_one.append(tocomparetwo_two)
        ...
        dispdata = tocomparethree_one.append(tocomparethree_two)
        dispdata = dispdata.append(tocomparethree_three)
        ...
        dispdata = tocomparefour_one.append(tocomparefour_two)
        dispdata = dispdata.append(tocomparefour_three)
        dispdata = dispdata.append(tocomparefour_four)
        ...
        dispdata = tocomparefive_one.append(tocomparefive_two)
        dispdata = dispdata.append(tocomparefive_three)
        dispdata = dispdata.append(tocomparefive_four)
        dispdata = dispdata.append(tocomparefive_five)
